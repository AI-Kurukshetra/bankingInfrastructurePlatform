...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden px-6 pb-20 pt-16 lg:px-10 lg:pb-24 lg:pt-20">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div>
          ...
          <h1 className="mt-6 text-balance text-5xl font-semibold tracking-[-0.04em] text-slate-950 sm:text-6xl">
        ...
        <Card className="overflow-hidden rounded-[2rem] border-slate-200 bg-white shadow-[0_30px_80px_rgba(37,99,235,0.12)]">
          <CardHeader className="border-b border-slate-200 bg-gradient-to-r from-blue-50 to-white pb-4">
            <CardTitle className="text-xl text-slate-950">Operations command center</CardTitle>
